...
- tupels : almost similar to array

## union type

- combinataion of muliple datatype
...
- array
  ...
  `let arrNumOfString: number[] = ['1', '2', 3'];` - 4 not allow
  `let data: string[] | number[] = [1, 2, 3];` - here still problem array can only number or array can be string
...
- Enumeration
- how to restrict the use choise
